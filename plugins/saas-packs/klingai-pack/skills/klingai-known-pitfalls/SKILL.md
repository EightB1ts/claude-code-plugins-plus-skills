...
[ ] Async job handling (polling or webhooks)
[ ] Prompt validation
[ ] Video download/storage (URLs expire)
[ ] Budget controls
...
Common Error Codes:
- 400: Bad request (check prompt/params)
- 401: Invalid API key
...
This entire skill is about error handling - apply the patterns shown above.
